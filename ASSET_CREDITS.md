...
- `sindirim.webp`: NIDDK/NIH, Your Digestive System & How It Works. https://www.niddk.nih.gov/health-information/digestive-diseases/digestive-system-how-it-works — kullanım açıklaması https://www.niddk.nih.gov/copyright
...
- `tugba-logo-yatay.png`: Kullanıcının seçtiği elma ve kelebek amblemli yatay logo. Yerleşik Imagegen ile kullanıcının marka yönlendirmesine göre oluşturulan özgün tasarım, 8 Eylül 2026. Üst menü, alt bilgi ve kurumun yapılandırılmış logo bilgisinde kullanılır.
- `tugba-logo-yatay-light.png`: Aynı yatay logonun koyu yeşil alt bilgi üzerinde okunaklı olması için açık renkli sürümü.
- `tugba-logo-ikon.png`: Yatay logodaki elma ve kelebek ambleminden oluşturulan kare favicon sürümü; tarayıcı sekmesinde kullanılır.
- `tugba-monogram.svg`: Önceki TŞA monogramı; geriye dönük dosya uyumluluğu için saklanır ve yeni sayfalarda kullanılmaz.
